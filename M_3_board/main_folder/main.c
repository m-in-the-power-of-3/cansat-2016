...
//============================================================================
	...
	while (1){
		switch(state_now) {
		take_data_for_packet(); // NOTE: Никогда не будет выполняться, так как не входит ни в один кейс
								// (нужно вынести из свича в while(1) )
		//============================================================================
		//WAIT SIGNAL
		//============================================================================
		...
		case STATE_WAIT_SEPARATION:
			...
			// NOTE: опять забытый брейк? Снова эклипс предупреждает
		//============================================================================
		//AFTER SEPARATION
		//============================================================================
